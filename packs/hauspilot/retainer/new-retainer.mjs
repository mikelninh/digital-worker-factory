...
const id=arg('id'),customer=arg('customer'),workflow=arg('workflow','repair_intake'),reviewer=arg('reviewer'),operator=arg('operator'),cadence=arg('cadence','monthly'),fee=Number(arg('fee','750'));
if(!id||!customer||!reviewer||!operator){console.error('Usage: node packs/hauspilot/retainer/new-retainer.mjs --id <slug> --customer "<name>" --reviewer "<name>" --operator "<name>" [--workflow repair_intake] [--cadence monthly] [--fee 750]');process.exit(2)}
